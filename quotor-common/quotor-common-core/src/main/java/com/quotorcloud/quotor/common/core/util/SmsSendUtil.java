...
import com.quotorcloud.quotor.common.core.constant.SmsSendRequest;
import com.quotorcloud.quotor.common.core.constant.SmsSendResponse;
...
public class SmsSendUtil {
    ...
    public static boolean isCaptchaPassTime(Long sendTime){
        ...
        if(now - sendTime > CommonConstants.PASS_TIME){
           return true;
        }
        return false;
    }
